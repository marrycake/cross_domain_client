...
class RsaHelper {
 public:
  ...
  static std::string encrypt(const CryptoPP::RSA::PublicKey &publicKey,
                             const std::string &data);
  static std::string decrypt(const CryptoPP::RSA::PrivateKey &privateKey,
                             const std::string &encryptMsg);
  static std::string sign(const CryptoPP::RSA::PrivateKey &privateKey,
                          const std::string &data);
  static bool verify(const std::string &message, const std::string &signature,
                     CryptoPP::RSA::PublicKey &publicKey);
  static CryptoPP::RSA::PublicKey loadPublicKeyFromStr(
      const std::string &publicKeyStr);
  static CryptoPP::RSA::PrivateKey loadPrivateKeyFromStr(
  ...
  static std::string dumpPublicKeyToStr(
      const CryptoPP::RSA::PublicKey &publicKey);
  static std::string dumpPrivateKeyToStr(
