...
{
    skin_list<<DEFAULT_SKIN<<":/skin/0"<<":/skin/1"<<":/skin/2"<<":/skin/3"<<":/skin/4"<<
...
void SkinWidget::paintEvent(QPaintEvent *event)
{
    ...
    // 此处直接改为默认皮肤,后面如果要用动态更换皮肤的功能,此处还需要改动
    QString skin_name = DEFAULT_SKIN;//Util::getSkinName();
	int height = 35;
