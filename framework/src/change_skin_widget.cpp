...
ChangeSkinWidget::ChangeSkinWidget(QWidget *parent) : QWidget(parent) {
  ...
  connect(use_skin_button, &QPushButton::clicked, this,
          &ChangeSkinWidget::useSkin);
...
void ChangeSkinWidget::useSkin() { emit changeSkin(); }

QString ChangeSkinWidget::getPixmapName() { return pixmap_name; }
