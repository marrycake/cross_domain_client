...
{
public:
    static void writeToFile(const char *msg, int len, const std::string &path, bool append);
    static void writeToFile(const std::string &msg, const std::string &path, bool append);
    ...
    static std::vector<char> readBytesFromPosition(const std::string &filePath, std::streampos position, std::size_t numBytes);
