...
void FileHelper::writeToFile(const char *msg, int len, const std::string &path, bool append)
{
...
void FileHelper::writeToFile(const std::string &msg, const std::string &path, bool append)
{
...
std::vector<char> FileHelper::readLastNBytes(const std::string &filename, int n)
{
...
std::vector<char> FileHelper::readBytesFromPosition(const std::string &filePath, std::streampos position, std::size_t numBytes)
{
